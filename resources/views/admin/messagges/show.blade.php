...
@section('content')
    ...
    <div class="container">
        ...
        <div class="card mb-3">
            <div class="row g-0">
                <div class="col-md-4">
                    <img src="{{ ' http://127.0.0.1:8000/storage/' . $apartment[0]->images[0]->path }}"
                        class="img-fluid rounded-start h-50" alt="{{ $apartment[0]->title }}">
                    <div class="m-3 p-2">

                        <h3 class="mb-2">{{ $apartment[0]->title }}</h3>
                        <h4>{{ $apartment[0]->address }}</h4>
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="card-body">
